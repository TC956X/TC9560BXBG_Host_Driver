...
#ifndef	__LINUX_USBNET_TC9560_H
#define	__LINUX_USBNET_TC9560_H
...
//#define TC9560_DRV_TEST_LOOPBACK 1
//#define TC9560_OUI_DEBUG 1
#define TC9560_VLAN_TAG			(0x8100)
#define ETH_TYPE_LEGACY			(0x9999)
#define TC9560_PHY_DETECT_INTERVAL (1000)

//#define DWC_ETH_QOS_SYSCLOCK        62500000 /* System clock is 62.5MHz */
#define DWC_ETH_QOS_SYSCLOCK        125000000 /* System clock is 62.5MHz */
#define DWC_ETH_QOS_AVB_ALGORITHM   27
#define	DWC_ETH_QOS_NO_HW_SUPPORT   -1
#define DWC_ETH_QOS_GET_CONNECTED_SPEED		25

#define TC9560_TX_DMA_CH_CNT 5
#define TC9560_RX_DMA_CH_CNT 6
#define TC9560_TX_LEG			0 
#define TC9560_TX_AVBA			1
#define TC9560_TX_AVBB			2
#define TC9560_TX_PTP			3

#define TC9560_TX_QUEUE_CNT (TC9560_TX_DMA_CH_CNT)
#define TC9560_RX_QUEUE_CNT (TC9560_RX_DMA_CH_CNT)
#define TC9560_QUEUE_CNT min(TC9560_TX_QUEUE_CNT, TC9560_RX_QUEUE_CNT)

#define TC9560_PHY_ID			    0x00    /* tc9560_tbd: need tc9560 phy id*/

#define TC9560_ACCESS_MAC			0x01   /* Vendor Specific command type to access mac registers */  
#define TC9560_ACCESS_USB			0x02   /* Reserved for future use */ 

#define PHYSICAL_LINK_STATUS		0x02
	#define	TC9560_USB_SS		0x04
	#define	TC9560_USB_HS		0x02
	#define	TC9560_USB_FS		0x01
...
#define TC9560_MAX_HASH_TABLE_SIZE     64
#define TC9560_MAX_ADDR_REG_CNT        32
#define DWC_ETH_QOS_HTR_CNT (TC9560_MAX_HASH_TABLE_SIZE/32)

/******************************************************************************/
//tc9560 private data structure  
struct tc9560_data {
...
//    void         (*tc9560_ptp)(struct usbnet *dev, struct sk_buff *skb);
...
#define TC9560_USB_CONFIG_1    1
#define TC9560_USB_CONFIG_2    2
#define TC9560_DEBUG           1
#define TC9560_FLAG_PTP        (1 << 9)

#define Y_SUCCESS 1

struct tc9560_int_data {
    __le16 res1;
#define TC9560_INT_PPLS_LINK       (1 << 0)
#define TC9560_INT_SPLS_LINK       (1 << 1)
#define TC9560_INT_CABOFF_UNPLUG   (1 << 7)
    u8 link;
    __le16 res2;
    u8 status;
    __le16 res3;
...
static int tc9560_AutoDetach(struct usbnet *dev, int in_pm);
#endif
...
#define IOCTL_TC9560_TIME       SIOCDEVPRIVATE+12
#define IOCTL_AVB_A_EP2_TX   SIOCDEVPRIVATE+9
